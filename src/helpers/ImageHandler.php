...
class ImageHandler {
    ...
    // Configurazione dimensioni massime (in pixel)
    ...
    public function __construct() {
        // Determina il percorso base relativo alla root del progetto
    ...
    private function getProjectRoot() {
        // Risale dalla cartella struct alla root
    ...
    public function caricaImmagine($file, $tipo, $slug) {
        ...
        // Se esiste già un file con questo nome, aggiungi timestamp
